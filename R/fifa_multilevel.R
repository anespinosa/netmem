...
#' 
#' @source Espinosa, Alejandro & Ortiz, Francisca (2016). "Jurisdictional autonomy in the regulatory transnational regime of FIFA". REDES- Revista Hispana para el Análisis de Redes Sociales, 27(1), 100- 112. (Original title in Spanish: "Autonomía jurisdiccional en el régimen regulatorio transnacional de la FIFA") <doi: https://doi.org/10.5565/rev/redes.595>
#'  
#' @docType data
#' 
"FIFAin"
